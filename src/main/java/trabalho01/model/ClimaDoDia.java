...
public class ClimaDoDia extends AplicationModel implements Serializable {
    ...
    public ClimaDoDia(Date data, String ventoDirecao, int ventoVelocidade, int indicePluciometrico,
            double temperatura) {
        this.data = data;
    ...
    public String toString() {
        ...
        String conteudo = dataString + "-" + ventoDirecao + "-" + ventoVelocidade + "-" + indicePluviometrico + "-"
                + temperatura;
        return conteudo;
    }
}
